...
export default function Sidebar({ entries, activeEntryId, onSelectEntry, onNewEntry }) {
  return (
    <div className="w-80 h-full flex flex-col gap-6 p-6 bg-slate-900 border-r border-white/5">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-white/5 border border-white/5 rounded-xl py-2 pl-10 pr-4 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500/50"
        />
      </div>
